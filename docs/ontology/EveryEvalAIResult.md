...
URI: [nexus:everyevalairesult](https://w3id.org/ai-atlas-nexus/everyevalairesult)
...
```mermaid
 classDiagram
    ...
    click EveryEvalAIResult href "../EveryEvalAIResult/"
      ...
      EveryEvalAIResult : hasLifecycleStatus





        EveryEvalAIResult --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      EveryEvalAIResult : hasRelatedRisk
        ...
        EveryEvalAIResult --> "*" RiskConcept : hasRelatedRisk
...
| Property  | Value                                                                        |
| --------- | ---------------------------------------------------------------------------- |
| Class URI | [nexus:everyevalairesult](https://w3id.org/ai-atlas-nexus/everyevalairesult) |
