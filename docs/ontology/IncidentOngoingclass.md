...
```mermaid
 classDiagram
    ...
    click IncidentOngoingclass href "../IncidentOngoingclass/"
      ...
      IncidentOngoingclass : hasLifecycleStatus





        IncidentOngoingclass --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      IncidentOngoingclass : isCategorizedAs





        IncidentOngoingclass --> "*" Any : isCategorizedAs
        click Any href "../Any/"
