...
```mermaid
 classDiagram
    ...
    click Impact href "../Impact/"
      ...
      Impact : hasJurisdiction





        Impact --> "*" Jurisdiction : hasJurisdiction
        click Jurisdiction href "../Jurisdiction/"



      Impact : hasLifecycleStatus





        Impact --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      Impact : isCategorizedAs





        Impact --> "*" Any : isCategorizedAs
        click Any href "../Any/"
      ...
      Impact : isMitigatedBy





        Impact --> "*" RiskControl : isMitigatedBy
        click RiskControl href "../RiskControl/"



      Impact : isUsedWithinLocality





        Impact --> "*" LocalityOfUse : isUsedWithinLocality
