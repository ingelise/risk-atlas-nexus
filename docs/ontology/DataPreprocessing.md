...
URI: [nexus:DataPreprocessing](https://w3id.org/ai-atlas-nexus/DataPreprocessing)
...
```mermaid
 classDiagram
    ...
    click DataPreprocessing href "../DataPreprocessing/"
      ...
      DataPreprocessing : hasLifecycleStatus





        DataPreprocessing --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      DataPreprocessing : isCategorizedAs





        DataPreprocessing --> "*" Any : isCategorizedAs
        click Any href "../Any/"
