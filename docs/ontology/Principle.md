...
```mermaid
 classDiagram
    ...
    click Principle href "../Principle/"
      ...
      Principle : hasExternalReference





        Principle --> "*" Documentation : hasExternalReference
        click Documentation href "../Documentation/"



      Principle : hasLifecycleStatus





        Principle --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      Principle : implementedByAdapter
        ...
        Principle --> "*" Any : implementedByAdapter
        click Any href "../Any/"
      ...
      Principle : requiresCapability
        ...
        Principle --> "*" Any : requiresCapability
        click Any href "../Any/"
