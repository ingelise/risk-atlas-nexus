...
URI: [nexus:modelinfo](https://w3id.org/ai-atlas-nexus/modelinfo)
...
```mermaid
 classDiagram
    ...
    click ModelInfo href "../ModelInfo/"
      ...
      ModelInfo : hasLifecycleStatus





        ModelInfo --> "0..1" LifecycleStatus : hasLifecycleStatus
...
| Property  | Value                                                        |
| --------- | ------------------------------------------------------------ |
| Class URI | [nexus:modelinfo](https://w3id.org/ai-atlas-nexus/modelinfo) |
