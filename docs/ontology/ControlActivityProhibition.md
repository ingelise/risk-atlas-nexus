...
URI: [nexus:ControlActivityProhibition](https://w3id.org/ai-atlas-nexus/ControlActivityProhibition)
...
```mermaid
 classDiagram
    ...
    click ControlActivityProhibition href "../ControlActivityProhibition/"
      ...
      ControlActivityProhibition : hasLifecycleStatus





        ControlActivityProhibition --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      ControlActivityProhibition : isApplicableToCapability





        ControlActivityProhibition --> "*" AiTask : isApplicableToCapability
      ...
      ControlActivityProhibition : notes
...
| Property  | Value                                                                                          |
| --------- | ---------------------------------------------------------------------------------------------- |
| Class URI | [nexus:ControlActivityProhibition](https://w3id.org/ai-atlas-nexus/ControlActivityProhibition) |
