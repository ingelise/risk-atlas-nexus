...
```mermaid
 classDiagram
    ...
    click IncidentStatus href "../IncidentStatus/"
      ...
      IncidentStatus : hasLifecycleStatus





        IncidentStatus --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      IncidentStatus : isCategorizedAs





        IncidentStatus --> "*" Any : isCategorizedAs
        click Any href "../Any/"
