...
URI: [nexus:ControlActivityObligation](https://w3id.org/ai-atlas-nexus/ControlActivityObligation)
...
```mermaid
 classDiagram
    ...
    click ControlActivityObligation href "../ControlActivityObligation/"
      ...
      ControlActivityObligation : hasLifecycleStatus





        ControlActivityObligation --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      ControlActivityObligation : isApplicableToCapability





        ControlActivityObligation --> "*" AiTask : isApplicableToCapability
        click AiTask href "../AiTask/"



      ControlActivityObligation : isCategorizedAs





        ControlActivityObligation --> "*" Any : isCategorizedAs
        click Any href "../Any/"
      ...
      ControlActivityObligation : notes
...
| Property  | Value                                                                                        |
| --------- | -------------------------------------------------------------------------------------------- |
| Class URI | [nexus:ControlActivityObligation](https://w3id.org/ai-atlas-nexus/ControlActivityObligation) |
