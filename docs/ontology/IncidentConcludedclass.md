...
```mermaid
 classDiagram
    ...
    click IncidentConcludedclass href "../IncidentConcludedclass/"
      ...
      IncidentConcludedclass : hasLifecycleStatus





        IncidentConcludedclass --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      IncidentConcludedclass : isCategorizedAs





        IncidentConcludedclass --> "*" Any : isCategorizedAs
        click Any href "../Any/"
