...
URI: [nexus:RiskControlGroupTaxonomy](https://w3id.org/ai-atlas-nexus/RiskControlGroupTaxonomy)
...
```mermaid
 classDiagram
    ...
    click RiskControlGroupTaxonomy href "../RiskControlGroupTaxonomy/"
      ...
      RiskControlGroupTaxonomy : hasLifecycleStatus





        RiskControlGroupTaxonomy --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      RiskControlGroupTaxonomy : notes
