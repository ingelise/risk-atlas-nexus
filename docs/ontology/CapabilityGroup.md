...
URI: [nexus:CapabilityGroup](https://w3id.org/ai-atlas-nexus/CapabilityGroup)
...
```mermaid
 classDiagram
    ...
    click CapabilityGroup href "../CapabilityGroup/"
      ...
      CapabilityGroup : hasJurisdiction





        CapabilityGroup --> "*" Jurisdiction : hasJurisdiction
      ...
      CapabilityGroup : isCategorizedAs





        CapabilityGroup --> "*" Any : isCategorizedAs
        click Any href "../Any/"
      ...
      CapabilityGroup : narrower

      CapabilityGroup : notes
