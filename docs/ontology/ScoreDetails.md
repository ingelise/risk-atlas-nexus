...
URI: [nexus:scoredetails](https://w3id.org/ai-atlas-nexus/scoredetails)
...
```mermaid
 classDiagram
    ...
    click ScoreDetails href "../ScoreDetails/"
      ...
      ScoreDetails : hasLifecycleStatus





        ScoreDetails --> "0..1" LifecycleStatus : hasLifecycleStatus
...
| Property  | Value                                                              |
| --------- | ------------------------------------------------------------------ |
| Class URI | [nexus:scoredetails](https://w3id.org/ai-atlas-nexus/scoredetails) |
