...
URI: [nexus:LargeLanguageModelFamily](https://w3id.org/ai-atlas-nexus/LargeLanguageModelFamily)
...
```mermaid
 classDiagram
    ...
    click LargeLanguageModelFamily href "../LargeLanguageModelFamily/"
      ...
      LargeLanguageModelFamily : hasLifecycleStatus





        LargeLanguageModelFamily --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      LargeLanguageModelFamily : isCategorizedAs





        LargeLanguageModelFamily --> "*" Any : isCategorizedAs
        click Any href "../Any/"
      ...
      LargeLanguageModelFamily : notes
