...
URI: [nexus:ControlActivityPermission](https://w3id.org/ai-atlas-nexus/ControlActivityPermission)
...
```mermaid
 classDiagram
    ...
    click ControlActivityPermission href "../ControlActivityPermission/"
      ...
      ControlActivityPermission : hasLifecycleStatus





        ControlActivityPermission --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      ControlActivityPermission : isApplicableToCapability





        ControlActivityPermission --> "*" AiTask : isApplicableToCapability
        click AiTask href "../AiTask/"



      ControlActivityPermission : isCategorizedAs





        ControlActivityPermission --> "*" Any : isCategorizedAs
        click Any href "../Any/"
      ...
      ControlActivityPermission : notes
...
| Property  | Value                                                                                        |
| --------- | -------------------------------------------------------------------------------------------- |
| Class URI | [nexus:ControlActivityPermission](https://w3id.org/ai-atlas-nexus/ControlActivityPermission) |
...
| [isApplicableToCapability](isApplicableToCapability.md) | \* <br/> [AiTask](AiTask.md)                                                     | This evidence only applies to AI systems with this capability                    | [ControlActivity](ControlActivity.md) |
