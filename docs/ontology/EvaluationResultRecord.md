...
URI: [nexus:evaluationresultrecord](https://w3id.org/ai-atlas-nexus/evaluationresultrecord)
...
```mermaid
 classDiagram
    ...
    click EvaluationResultRecord href "../EvaluationResultRecord/"
      ...
      EvaluationResultRecord : hasLifecycleStatus





        EvaluationResultRecord --> "0..1" LifecycleStatus : hasLifecycleStatus
...
| Property  | Value                                                                                  |
| --------- | -------------------------------------------------------------------------------------- |
| Class URI | [nexus:evaluationresultrecord](https://w3id.org/ai-atlas-nexus/evaluationresultrecord) |
