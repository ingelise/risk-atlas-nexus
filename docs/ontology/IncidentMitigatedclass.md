...
```mermaid
 classDiagram
    ...
    click IncidentMitigatedclass href "../IncidentMitigatedclass/"
      ...
      IncidentMitigatedclass : hasLifecycleStatus





        IncidentMitigatedclass --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      IncidentMitigatedclass : isCategorizedAs





        IncidentMitigatedclass --> "*" Any : isCategorizedAs
        click Any href "../Any/"
