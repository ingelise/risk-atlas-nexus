...
```mermaid
 classDiagram
    ...
    click AIUser href "../AIUser/"
      ...
      AIUser : hasLifecycleStatus





        AIUser --> "0..1" LifecycleStatus : hasLifecycleStatus
...
| ----------------------- | ------------------------- | ----- | ------------------- |
| [AiSystem](AiSystem.md) | [hasAIUser](hasAIUser.md) | range | [AIUser](AIUser.md) |
| [AiAgent](AiAgent.md)   | [hasAIUser](hasAIUser.md) | range | [AIUser](AIUser.md) |
