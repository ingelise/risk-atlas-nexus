...
URI: [nexus:StakeholderGroup](https://w3id.org/ai-atlas-nexus/StakeholderGroup)
...
```mermaid
 classDiagram
    ...
    click StakeholderGroup href "../StakeholderGroup/"
      ...
      StakeholderGroup : hasLifecycleStatus





        StakeholderGroup --> "0..1" LifecycleStatus : hasLifecycleStatus
