...
URI: [nexus:RiskTaxonomy](https://w3id.org/ai-atlas-nexus/RiskTaxonomy)
...
```mermaid
 classDiagram
    ...
    click RiskTaxonomy href "../RiskTaxonomy/"
      ...
      RiskTaxonomy : hasLifecycleStatus





        RiskTaxonomy --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      RiskTaxonomy : isCategorizedAs





        RiskTaxonomy --> "*" Any : isCategorizedAs
        click Any href "../Any/"
