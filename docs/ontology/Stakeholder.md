...
```mermaid
 classDiagram
    ...
    click Stakeholder href "../Stakeholder/"
      ...
      Stakeholder : hasLifecycleStatus





        Stakeholder --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      Stakeholder : isCategorizedAs





        Stakeholder --> "*" Any : isCategorizedAs
        click Any href "../Any/"
...
| Property  | Value                                                 |
| --------- | ----------------------------------------------------- |
| Class URI | [airo:Stakeholder](https://w3id.org/airo#Stakeholder) |
