...
```mermaid
 classDiagram
    ...
    click Certification href "../Certification/"
      ...
      Certification : hasExternalReference





        Certification --> "*" Documentation : hasExternalReference
        click Documentation href "../Documentation/"



      Certification : hasLifecycleStatus





        Certification --> "0..1" LifecycleStatus : hasLifecycleStatus
      ...
      Certification : isCategorizedAs





        Certification --> "*" Any : isCategorizedAs
        click Any href "../Any/"
