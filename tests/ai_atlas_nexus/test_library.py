...
class TestLibrary(TestCaseBase):
    ...
    def test_get_risk_incidents(self):
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.riskincidents = [RiskIncident(id="test-ri")]
    ...
    def test_get_related_risk_incidents(self):
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.riskincidents = [
    ...
    def test_get_all_evaluations(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._evaluations = [AiEval(id="test-eval1")]
    ...
    def test_get_evaluation_by_id(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data._evaluations = [AiEval(id="test-eval1")]
        evaluation = ran_lib.get_evaluation(id="test-eval1")
        assert evaluation.id == "test-eval1"

    def test_get_related_evaluations(self):
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data._evaluations = ran_lib._atlas_explorer._evaluations + [
    ...
    def test_get_all_benchmark_metadata_cards(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.benchmarkmetadatacards = [
    ...
    def test_get_all_documents(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._documents = [Documentation(id="test-ds1")]
    ...
    def test_get_document_by_id(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.documents = [Documentation(id="test-ds1")]
    ...
    def test_get_all_stakeholders(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.stakeholders = [Stakeholder(id="test-stakeholder1")]
    ...
    def test_get_all_intrinsics(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.llmintrinsics = [LLMIntrinsic(id="test-intrinsic")]
    ...
    def test_get_intrinsic_by_id(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.llmintrinsics = [LLMIntrinsic(id="test-intrinsic1")]
    ...
    def test_get_related_intrinsics(self):
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.llmintrinsics = ran_lib._atlas_explorer._data.llmintrinsics + [
    ...
    def test_get_all_principles(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.principles = [Principle(id="test-principle")]
    ...
    def test_get_principle_by_id(self):
        ...
        ran_lib = self.ran_lib
        ran_lib._atlas_explorer._data.principles = [Principle(id="test-principle1")]
